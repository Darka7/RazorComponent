...
declare global {
    ...
    export class AutoNumeric {
        constructor(
            ...
            options?: IAutoNumeric.Options | string | null
        );
        ...
        static multiple(
            ...
            options?: IAutoNumeric.Options | IAutoNumeric.Options[] | null
        ): AutoNumeric[];

        /**
         * Return true in the settings are valid
         */
        static areSettingsValid(options: IAutoNumeric.Options): boolean;

        /**
         * Format the given number with the given options. This returns the formatted value as a string.
         */
        static format(value: number | string | HTMLElement, options: IAutoNumeric.Options): string;

        /**
         * Format the domElement value with the given options and returns the formatted value as a string.
         */
        static formatAndSet(domElement: HTMLElement, options: IAutoNumeric.Options): string;
         ...
         */
        static getDefaultConfig(): IAutoNumeric.Options;

        /**
         * Return all the predefined options in one object
         */
        static getPredefinedOptions(): IAutoNumeric.PredefinedOptions;
         ...
         */
        static localize(value: string | HTMLElement, options: IAutoNumeric.Options): string;

        static localizeAndSet(domElement: HTMLElement, options: IAutoNumeric.Options): string;

        static mergeOptions(...options: IAutoNumeric.Options[]): IAutoNumeric.Options;

        static reformatAndSet(referenceToTheDomElement: HTMLElement): void;

        static test(domElement: HTMLElement): boolean;

        static validate(options: IAutoNumeric.Options): boolean;
         ...
         */
        setUnformatted(value: number, options?: IAutoNumeric.Options): void;
         ...
         */
        getLocalized(forcedOutputFormat?: IAutoNumeric.OutputFormatOption, callback?: (value: string) => void): string;
        ...
        unformatLocalized(forcedOutputFormat?: IAutoNumeric.OutputFormatOption): void;
         ...
         */
        update(...options: IAutoNumeric.Options[]): AutoNumeric;
        ...
        formLocalized(forcedOutputFormat?:  IAutoNumeric.PredefinedLanguages): string;
