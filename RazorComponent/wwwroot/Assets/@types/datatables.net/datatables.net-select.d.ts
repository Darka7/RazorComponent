    ...
    namespace DataTables {
        ...
        interface Api<T> {
            select: {
                ...
                * @returns DataTables API instance for chaining.
                */
                style(s: "api" | "single" | "multi" | "os"): Api<T>;
                 ...
                 * @returns DataTables API instance for chaining.
                 */
                toggleable(set): Api<T>;
            };
        }

        interface RowMethods<T> {
            /**
             * Select a row
             */
            select(): Api<T>;
