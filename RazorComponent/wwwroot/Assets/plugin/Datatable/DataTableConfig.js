...
(function (App) {
    ...
    function GridTable(el, Colums, UrlData, UrlEdit, UrlDelete, Security, Buttons, Defaults) {
        ...
        if (Buttons != null) {
            ...
            (_a = options.buttons.buttons).push.apply(_a, btnsCreated);
        }
        /// btns  export
        if (!App.isNullOrEmpty(Defaults.BtnDefaults)) {
            ...
            if (colvis != null) {
                ...
                (_b = options.buttons.buttons).push.apply(_b, NewBtnsDefaults);
            }
            else {
                (_c = options.buttons.buttons).push.apply(_c, Defaults.BtnDefaults);
            }
        }
        //colum Accion
